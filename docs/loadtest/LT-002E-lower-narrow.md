...
> Historical note: 이 문서는 2026-03 계열 lower-narrow 결과 기록이다. 2026-07-09 재검증(`LT-002E-2026-07-09_213445`) 이후 40 RPS부터 E2E p95 sustained check 실패로 판단했다. LT-003 `LT-003-2026-07-09_223737`에서는 30 RPS가 안정 steady 기준선으로 채택됐고, 35 RPS는 tail spike 재검증 대상으로 남겼다.
