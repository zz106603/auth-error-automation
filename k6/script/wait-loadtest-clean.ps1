...
function Write-StateSample {
  ...
  ("[{0}] clean={1} clean_seconds={2} ready={3:N3} unacked={4:N3} retry={5:N3} dlq={6:N3} outbox_count={7:N3} outbox_p95={8:N3} outbox_p99={9:N3} hikari_pending={10:N3}" -f `
    ...
    $sample.outbox_backlog_count, $sample.outbox_age_p95_ms, $sample.outbox_age_p99_ms,
